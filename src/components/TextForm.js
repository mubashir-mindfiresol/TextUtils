...
export default function TextForm(props) {
    ...
    const handleCopy = () => {
        // console.log("Copy text btn was clicked");
    ...
    setText(res1)
    props.showAlert("Removed Symbols","success");
    };
    ...
    return (
        <>
            <div className="container" style={{color: props.mode==='dark'?'white':'black'}}>
                ...
                <button className="btn btn-info mx-2" onClick={handletextExtract}>
                    Remove Symbols
                </button>
                <button className="btn btn-info mx-2" onClick={handleNumExtract}>
                    Extract Numbers
                </button>
                <button className="btn btn-info mx-2" onClick={handleCopy}>
                    Copy Text
                </button>
                <button className="btn btn-light mx-2" onClick={handleClearClick}>
                    Clear Text
                </button>
            </div>
